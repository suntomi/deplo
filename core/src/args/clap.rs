...
lazy_static! {
    ...
    static ref G_ROOT_MATCH: ArgMatches = Command::new("deplo")
        ...
        .arg(Arg::new("ci")
            .long("ci")
            .value_name("CI_ACCOUNT_NAME")
            .help("Sets CI account name in Deplo.toml for local execution"))
        .arg(Arg::new("debug")
            .short('d')
            .long("debug")
            ...
            Command::new("ci")
                ...
                .subcommand(
                    ...
                    .arg(Arg::new("key")
                        ...
                        .required(true))
                    .arg(Arg::new("value")
                        .help("secret value to set. if omitted, prints the resolved local secret value")
                        .index(2)
                        .required(false))
                )
                .subcommand(
                    ...
                    .arg(Arg::new("key")
                        ...
                        .required(true))
                    .arg(Arg::new("value")
                        .help("variable value to set. if omitted, prints the resolved local variable value")
                        .index(2)
                        .required(false))
                )
                .subcommand(
